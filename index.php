	...
	if (mysql_num_rows($sql) == 1) {
		...
		switch ($_GET["task"]) {
			...
			case 'la':
				...
				echo "<a alt=\"Show top processes\" href=\"http://" .$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']). "/index.php?task=top&serverip=" .$_GET['serverip']. "\" style='text-decoration: none;' target='_blank'>";
				if ($la1 < ($core/2)) {
