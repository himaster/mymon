...
<head>
    ...
    <link rel="icon" href="http://<?php echo $_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']).$_SERVER['REQUEST_URI']; ?>/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="http://<?php echo $_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']).$_SERVER['REQUEST_URI']; ?>/favicon.ico" type="image/x-icon">
</head>
