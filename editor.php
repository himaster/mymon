...
<?php
	...
	<tr>
		...
		<td class="color"><input id="<?php echo trim($row_user['servername']) ?>^color" type="color" <?php if (trim($row_user['color']) == 1) echo "checked "; ?> oninput="javascript: alert(this.id + ' : ' + this.value);"></td>
	</tr>
	<?php } ?>
</table>