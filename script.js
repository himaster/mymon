...
$(document).ready(function() {
    ...
    times(100, function() {
        ...
        if (window.innerWidth-40 < main_table.offsetWidth) el.style.fontSize = (fontSize - 1) + 'px';
        else if (window.innerWidth-40 > main_table.offsetWidth) el.style.fontSize = (fontSize + 1) + 'px';
    });
