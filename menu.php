...
<div id="my_div" class="menu">
	...
	<?php
		...
		echo "<p><input type=\"submit\" id=\"submit\" style=\"display: none; \">";
		echo "<p><a href=\"javascript: toggle_visibility('password'); toggle_visibility('password2'); toggle_visibility('email'); toggle_visibility('submit');\">Edit profile</a>";
