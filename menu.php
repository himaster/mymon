...
<div id="my_div" class="menu">
	...
	<?php
		...
		echo "<p><input type=\"password\" name=\"password\" style=\"visibility: hidden; \">";
		echo "<p><input type=\"password\" name=\"password2\" style=\"visibility: hidden; \">";
		echo "<p><input type=\"text\" name=\"email\" style=\"visibility: hidden; \" value=\"".mysql_fetch_assoc($sql)["email"]."\">";
